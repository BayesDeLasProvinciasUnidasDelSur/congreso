...
\LARGE \textcolor{black!85}{\fontsize{22}{0}\selectfont \textbf{Congreso Bayesiano del Sur}}
\end{textblock}
...
\end{textblock}
\begin{textblock}{160}(0,6) \centering
\LARGE \textcolor{black!85}{ \hspace{2.5cm} \scalebox{3.7}{S} }
\end{textblock}
...
\begin{textblock}{160}(01,70)
\textcolor{black!5}{\textbf{\Large Curso 2022 - 2023 \\
\normalsize Metodologías del conocimiento\\
empírico. Acuerdos inte$\dots$umbre \\}}
\end{textblock}
...
\hspace{1.2cm} Monte Markov chain Monte Carlo. \\
\hspace{1.8cm} Metrópolis-Hasting y Hamiltonian. \\
}
\end{textblock}
...
\textcolor{black!15}{Capítulo 12 \\ \small
