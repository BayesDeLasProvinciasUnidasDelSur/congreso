...
\es{La lógica con incertidumbre (teoría de la probabilidad) ha sido derivada repetidas veces a partir de principios (axiomas) distintos, llegando siempre a las mismas dos simples reglas.}%
%
