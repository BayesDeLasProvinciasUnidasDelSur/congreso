...
%
No importa el pago de la casa de apuestas, lo mejor que podemos hacer a largo plazo es dividir los recursos en partes iguales, si sabemos que la moneda es no sesgada.
%
Pero a pesar de que el promedio sea positivo, $( Q_c \, b \, p + Q_s \, (1-b) \, (1-p)) = 1.05$, con $b = p = 0.5$, todos las trayectorias individuales caen a una tasa de $5\%$, pues la tasa de crecimiento es $r_b = 0.95$
